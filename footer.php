	...
	<div id="footer" class="clearfix">
		...
		<div class="right">
			<!-- GetClicky Analytics -->
			<a title="Web Analytics" href="http://getclicky.com/123803"><img alt="Web Analytics" src="http://static.getclicky.com/media/links/badge.gif" border="0" class="invisible" /></a>
